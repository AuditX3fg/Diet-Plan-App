...
const styles = StyleSheet.create({
  ...
  fruitCard: { position: 'relative', width: '31.5%', minHeight: 128, paddingHorizontal: 7, paddingVertical: 12, borderRadius: 18, borderWidth: 1, alignItems: 'center', justifyContent: 'center' },
  fruitDisabled: { opacity: 0.42 },
  fruitGlyph: { fontSize: 28, lineHeight: 35 },
  fruitName: { minHeight: 38, marginTop: 3, textAlign: 'center', fontSize: 14, lineHeight: 18, fontWeight: '900' },
  fruitAmount: { marginTop: 3, fontSize: 11, lineHeight: 14, fontWeight: '700' },
